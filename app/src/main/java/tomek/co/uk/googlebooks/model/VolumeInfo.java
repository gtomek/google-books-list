...
public class VolumeInfo implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeTypedList(this.industryIdentifiers);
    ...
    protected VolumeInfo(Parcel in) {
        ...
        this.industryIdentifiers = new ArrayList<IndustryIdentifier>();
        in.readTypedList(this.industryIdentifiers, IndustryIdentifier.CREATOR);
